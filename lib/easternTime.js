 ...
 * characters cost.
 *
 * Year in full rather than tubafrenzy's and dj-site's two-digit `M/D/YY`: the
 * archive runs back to 2004, and on a page that can show two decades in one
 * scroll "05" is ambiguous in a way it never was on a page showing one day.
 *
 * @param {string} isoTimestamp ISO 8601 timestamp.
