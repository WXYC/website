...
The music department consists of the music director and a staff that join. This group is responsible for reviewing new music and choosing which releases are placed in the playlist.

For current managers and contact information, see the [contact page](https://wxyc.org/contact).

### Funding

WXDU receives funding from the Duke University Union(DUU), and works with the committee to ensure cohesion and alignment of missions between the school and the station. We supplement those funds with fundraising events and regular donations from generous mysterious benefactors. We do not currently accept advertising or underwriting.
